 ...
 * @returns {string}
 */
export const getBlobUrl = (base64Buf: string) => {
  if (base64Buf) {
...
export const getModulesDefaultContent = <T = unknown>(modules: ModulesDefaultType) => {
  const _routeModuleList: T[] = [];
